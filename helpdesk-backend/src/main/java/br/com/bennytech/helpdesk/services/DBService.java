...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico tec1 = new Tecnico(null, "Valdir Cesar", "672.652.190-15", "valdir@mail.com", encoder.encode("123"));
		...
		Cliente cli1 = new Cliente(null, "Alexandre De Moraes", "031.255.190-80", "alex@gmail.com", encoder.encode("123"));
